    ...
    <div className="cvb-william-resume">
      <div className="cvb-william-header">
        ...
        <div className="cvb-william-contacts">
          <p className="cvb-william-contact-item"><strong>EMAIL</strong><br /><span className="cvb-william-contact-value">{personal.email || "kalingaramarao181@gmail.com"}</span></p>
          <p className="cvb-william-contact-item"><strong>PHONE</strong><br /><span className="cvb-william-contact-value">{personal.phone}</span></p>
          <p className="cvb-william-contact-item"><strong>LINKEDIN</strong><br /><span className="cvb-william-contact-value">{personal.linkedin}</span></p>
        </div>
      </div>
      ...
      <div className="cvb-william-section">
        ...
        <ul className="cvb-william-skills">
          {skills.map((skill, index) => (
            <li key={index} className="cvb-william-skill-item"><strong>{skill.skill_name}</strong> - {skill.level}</li>
          ))}
