    ...
    <div className="cvb-first-resume-container">
      <div className="cvb-first-sidebar">
        <div className="cvb-first-contact">
          ...
          <p className="cvb-first-contact-item">Email: {personal.email || "kalingaramarao181@gmail.com"}</p>
      ...
      <div className="cvb-first-main-content">
        ...
        <section className="cvb-first-education-section">
          ...
          <p className="cvb-first-paragraph">
            <strong>Associate in Computer Science</strong> – Saint Maria University<br />
            Sep 2011 – Jul 2014
          </p>
          <p className="cvb-first-paragraph">Graduated with the highest academy remarks.</p>
        </section>
      </div>
    </div>
  );
